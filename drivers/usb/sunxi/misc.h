...
extern struct sunxi *global_sunxi;
...
#else
static inline void sunxi_valength_dummy(void *p, char *fmt, ...) {}
#define dev_dbg(dev, format, ...) sunxi_valength_dummy(dev, format, ## __VA_ARGS__)
#define dev_vdbg(dev, format, ...) sunxi_valength_dummy(dev, format, ## __VA_ARGS__)
#define pr_debug(format, ...) sunxi_valength_dummy(NULL, format, ## __VA_ARGS__)
#endif
...
extern unsigned int sunxi_cable_connected;
extern unsigned int sunxi_high_speed;
